...
| [Lineage and Tracklet Accuracy](lineage-accuracy-metrics) | `one-to-one`, `many-to-one` | A set of metrics that computes the fraction of tracklets or lineages that are fully correct over a sliding window of N frames. |
